...
public final class ReflectionUtils
{
  ...
  public static void setPrivateField(final Class<?> clazz, final Object handle, final String fieldName, final Object value) throws Exception {
  ...
  public static Object getConnection(final Player player) throws SecurityException, NoSuchMethodException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
